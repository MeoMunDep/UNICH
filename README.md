...
- Fill the data for `datas.txt` file, get data from [here](https://t.me/KeoAirDropFreeNe/257/46332). This file contains user data in the following format:
...
- **Help me with your referral** [Referral Link](https://t.me/KeoAirDropFreeNe/257/46332)
